...
//   // Handle whiteboard updates
//   socket.on('whiteboardUpdate', ({ taskId, data, userId }) => {
//     handleWhiteboardUpdate(socket, taskId, data, userId);
//   });
...
// // Function to handle whiteboard updates
// function handleWhiteboardUpdate(socket, taskId, data, userId) {
//   socket.broadcast.to(taskId).emit('whiteboardUpdate', data);
//   console.log(`User ${userId} updated whiteboard in task ${taskId}`);
// }
